...
def RSSI_Loc_BatchedGD_5par(data, numEpoch, numIterations, threshold, learning_rate):
    ...
    for j in range(0, numEpoch):
        theta = np.array([np.random.normal(-20.0,1), np.random.normal(0,50),np.random.normal(0,50),np.random.normal(2,1),1])
        # theta = np.array([random.uniform(-30, -20), random.uniform(-100, 100), random.uniform(-100, 100), random.uniform(0, 4),random.uniform(0, 5)])
        # theta = np.array([random.uniform(-26.0, -23.0), random.uniform(-100.0, 100.0), random.uniform(-100.0, 100.0), random.uniform(0.0, 4.0), random.uniform(0, 1)])
