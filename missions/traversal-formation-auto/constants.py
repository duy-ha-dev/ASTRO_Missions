...
# Meters apart of each drone's altitude during take-off and formation assumption
INITIAL_VERTICAL_SEPARATION = 4.0
...
# Meters from the formation center to each of the drones
