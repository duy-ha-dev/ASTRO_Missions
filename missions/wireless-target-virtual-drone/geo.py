...
from gradient_descent import GPS2UTM_raw
...
class Coordinate(object):
    ...
    def get_triangle_coord(self, hotspot):
        triangle_size = self.distance_to(hotspot) * sqrt(3)
        [vx1, vy1, vz1, vzone_number, vzone_letter] = GPS2UTM_raw(self.lat, self.lon, 1)
        [hx1, hy1, hz1, hzone_number, hzone_letter] = GPS2UTM_raw(hotspot.lat, hotspot.lon, 1)
        vertex2, vertex3 = IntersectPoints(complex(vx1, vy1), complex(hx1,hy1), triangle_size, vertex1.distance_to(hotspot))
