...
class HoverMission(Mission):
    ...
    def start_mission(self, data, *args, **kwargs):
	    ...
	    # Moving to location 1
            ...
            nextlat, nextlon = 29.71593648677779, -95.40923191420089
            ...
            nextlat, nextlon = 29.716008531369425, -95.40925532398833
            ...
            nextlat, nextlon = 29.71612824650274, -95.40925613598104
