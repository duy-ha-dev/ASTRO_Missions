...
class HoverMission(Mission):
    ...
    def start_mission(self, data, *args, **kwargs):
        ...
        try:
            ...
            nextlat, nextlon = 29.716423867384187, -95.40938646020639
            ...
            nextlat, nextlon = 29.716599394113555, -95.4092964393064
            ...
            nextlat, nextlon = 29.716791013709624, -95.40915353845378
